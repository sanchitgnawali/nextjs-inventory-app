            ...
            <nav className="space-y-1">
                <div className="text-sm font-semibold text-gray-400 uppercase mb-2">Inventory</div>
                {
                    navigation.map((item, key) => {
                        ...
                        return <Link href={item.href} key={key} className={`flex items-center space-x py-2 px-2 rounded-lg ${isActive  ? "bg-purple-100 text-gray-800" : "text-gray-300 hover:bg-gray-800"}` }>
